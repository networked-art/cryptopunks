...
## Modern CryptoPunks721

The modern wrapper uses the owner's Stash as the deposit target. A full wrap is
...
await punks.wrappers.modern.transferFrom({ from: owner, to: receiver, punkId: 8348 })
```
