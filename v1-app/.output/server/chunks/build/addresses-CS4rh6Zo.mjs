import { v as vueExports, V as Ve$1, d as useRuntimeConfig } from './server.mjs';

const punksMarketAbi = [
  {
    "inputs": [],
...
const PUNKS_V1_ADDRESS = Ve$1;
function usePunksMarketAddress() {
  const config = useRuntimeConfig();
  const fromConfig = config.public.punksMarketAddress ?? "";
...
export { PUNKS_V1_ADDRESS as P, punksMarketAbi as p, usePunksMarketAddress as u };
//# sourceMappingURL=addresses-CS4rh6Zo.mjs.map
