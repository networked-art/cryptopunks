...
export const PunksMarketAbi = parseAbi([
  ...
  'event BidAccepted(uint256 indexed bidId, uint256 indexed punkId, address indexed seller, address bidder, address settler, uint96 listingWei, uint96 bidWei, uint96 settlementWei)',
  'event PunkPurchased(uint256 indexed punkId, address indexed seller, address indexed recipient, address buyer, uint96 listingWei)',
