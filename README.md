...
| [`indexer/`](indexer/README.md)                    | `@networked-art/punks-indexer`   | Ponder indexer that tracks `CryptoPunks` and `CryptoPunksMarket`, their ERC-721 wrappers, and `PunksMarket`, with USD-cent prices stamped per event.                          |
