...
export const punksV1MarketAbi = [
  ...
  { type: 'error', name: 'ListingPriceMismatch', inputs: [{ name: 'expectedListingWei', type: 'uint96' }, { name: 'actualListingWei', type: 'uint256' }] },
  ...
  { type: 'event', name: 'BidAccepted', anonymous: false, inputs: [{ name: 'bidId', type: 'uint256', indexed: true }, { name: 'punkId', type: 'uint256', indexed: true }, { name: 'seller', type: 'address', indexed: true }, { name: 'bidder', type: 'address' }, { name: 'settler', type: 'address' }, { name: 'listingWei', type: 'uint96' }, { name: 'bidWei', type: 'uint96' }, { name: 'settlementWei', type: 'uint96' }] },
  { type: 'event', name: 'BidAdjusted', anonymous: false, inputs: [{ name: 'bidId', type: 'uint256', indexed: true }, { name: 'newBidWei', type: 'uint96' }] },
  { type: 'event', name: 'BidCancelled', anonymous: false, inputs: [{ name: 'bidId', type: 'uint256', indexed: true }] },
  { type: 'event', name: 'BidPlaced', anonymous: false, inputs: [{ name: 'bidId', type: 'uint256', indexed: true }, { name: 'bidder', type: 'address', indexed: true }, { name: 'bidWei', type: 'uint96' }, { name: 'settlementWei', type: 'uint96' }, { name: 'criteria', type: 'tuple', components: [{ name: 'requiredTraitMask', type: 'uint256' }, { name: 'forbiddenTraitMask', type: 'uint256' }, { name: 'anyOfTraitMask', type: 'uint256' }, { name: 'requiredColorMask', type: 'uint256' }, { name: 'forbiddenColorMask', type: 'uint256' }, { name: 'anyOfColorMask', type: 'uint256' }, { name: 'minPixelCount', type: 'uint16' }, { name: 'maxPixelCount', type: 'uint16' }, { name: 'minColorCount', type: 'uint8' }, { name: 'maxColorCount', type: 'uint8' }] }, { name: 'includeIds', type: 'uint16[]' }, { name: 'excludeIds', type: 'uint16[]' }] },
  { type: 'event', name: 'Credited', anonymous: false, inputs: [{ name: 'account', type: 'address', indexed: true }, { name: 'amount', type: 'uint256' }] },
  { type: 'event', name: 'PunkPurchased', anonymous: false, inputs: [{ name: 'punkId', type: 'uint256', indexed: true }, { name: 'seller', type: 'address', indexed: true }, { name: 'recipient', type: 'address', indexed: true }, { name: 'buyer', type: 'address' }, { name: 'listingWei', type: 'uint96' }] },
  { type: 'event', name: 'Withdrawal', anonymous: false, inputs: [{ name: 'account', type: 'address', indexed: true }, { name: 'amount', type: 'uint256' }] },
  { type: 'function', name: 'PUNKS_CRITERIA', inputs: [], outputs: [{ type: 'address' }], stateMutability: 'view' },
  { type: 'function', name: 'PUNKS_DATA', inputs: [], outputs: [{ type: 'address' }], stateMutability: 'view' },
  { type: 'function', name: 'PUNKS_V1', inputs: [], outputs: [{ type: 'address' }], stateMutability: 'view' },
  { type: 'function', name: 'PUNKS_VISUAL', inputs: [], outputs: [{ type: 'address' }], stateMutability: 'view' },
  { type: 'function', name: 'acceptBid', inputs: [{ name: 'bidId', type: 'uint256' }, { name: 'punkId', type: 'uint16' }, { name: 'expectedListingWei', type: 'uint96' }], outputs: [], stateMutability: 'nonpayable' },
  { type: 'function', name: 'adjustBidPrice', inputs: [{ name: 'bidId', type: 'uint256' }, { name: 'weiToAdjust', type: 'uint96' }, { name: 'increase', type: 'bool' }], outputs: [], stateMutability: 'payable' },
  { type: 'function', name: 'balances', inputs: [{ type: 'address' }], outputs: [{ type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'bids', inputs: [{ name: 'bidId', type: 'uint256' }], outputs: [{ name: 'bidWei', type: 'uint96' }, { name: 'settlementWei', type: 'uint96' }, { name: 'bidder', type: 'address' }], stateMutability: 'view' },
  { type: 'function', name: 'bidsMatchingPunk', inputs: [{ name: 'punkId', type: 'uint16' }, { name: 'fromId', type: 'uint256' }, { name: 'count', type: 'uint256' }], outputs: [{ name: 'bidIds', type: 'uint256[]' }, { name: 'nextId', type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'buyPunk', inputs: [{ name: 'punkId', type: 'uint16' }, { name: 'expectedListingWei', type: 'uint96' }, { name: 'recipient', type: 'address' }], outputs: [], stateMutability: 'payable' },
  { type: 'function', name: 'cancelBid', inputs: [{ name: 'bidId', type: 'uint256' }], outputs: [], stateMutability: 'nonpayable' },
  { type: 'function', name: 'getBidCriteria', inputs: [{ name: 'bidId', type: 'uint256' }], outputs: [{ type: 'tuple', components: [{ name: 'requiredTraitMask', type: 'uint256' }, { name: 'forbiddenTraitMask', type: 'uint256' }, { name: 'anyOfTraitMask', type: 'uint256' }, { name: 'requiredColorMask', type: 'uint256' }, { name: 'forbiddenColorMask', type: 'uint256' }, { name: 'anyOfColorMask', type: 'uint256' }, { name: 'minPixelCount', type: 'uint16' }, { name: 'maxPixelCount', type: 'uint16' }, { name: 'minColorCount', type: 'uint8' }, { name: 'maxColorCount', type: 'uint8' }] }], stateMutability: 'view' },
  { type: 'function', name: 'getBidExcludeIds', inputs: [{ name: 'bidId', type: 'uint256' }], outputs: [{ type: 'uint16[]' }], stateMutability: 'view' },
  { type: 'function', name: 'getBidIncludeIds', inputs: [{ name: 'bidId', type: 'uint256' }], outputs: [{ type: 'uint16[]' }], stateMutability: 'view' },
  { type: 'function', name: 'lastBidId', inputs: [], outputs: [{ type: 'uint256' }], stateMutability: 'view' },
  { type: 'function', name: 'matchesPunk', inputs: [{ name: 'bidId', type: 'uint256' }, { name: 'punkId', type: 'uint16' }], outputs: [{ type: 'bool' }], stateMutability: 'view' },
  { type: 'function', name: 'placeBid', inputs: [{ name: 'bidWei', type: 'uint96' }, { name: 'settlementWei', type: 'uint96' }, { name: 'criteria', type: 'tuple', components: [{ name: 'requiredTraitMask', type: 'uint256' }, { name: 'forbiddenTraitMask', type: 'uint256' }, { name: 'anyOfTraitMask', type: 'uint256' }, { name: 'requiredColorMask', type: 'uint256' }, { name: 'forbiddenColorMask', type: 'uint256' }, { name: 'anyOfColorMask', type: 'uint256' }, { name: 'minPixelCount', type: 'uint16' }, { name: 'maxPixelCount', type: 'uint16' }, { name: 'minColorCount', type: 'uint8' }, { name: 'maxColorCount', type: 'uint8' }] }, { name: 'includeIds', type: 'uint16[]' }, { name: 'excludeIds', type: 'uint16[]' }], outputs: [{ name: 'bidId', type: 'uint256' }], stateMutability: 'payable' },
